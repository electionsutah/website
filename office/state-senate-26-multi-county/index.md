---
layout: page
title: State Senate 26 (Multi County)
permalink: /office/state-senate-26-multi-county
comments: true
---
...
{% assign office = site.data.2018.primary.candidates | where:'office','State Senate 26 (Multi County)' | sort:'last_name' %}
<table>
<thead>
  <th>First Name</th>
  <th>Last Name</th>
