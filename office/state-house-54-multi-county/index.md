---
layout: page
title: State House 54 (Multi County)
permalink: /office/state-house-54-multi-county
comments: true
---
...
{% assign office = site.data.2018.primary.candidates | where:'office','State House 54 (Multi County)' | sort:'last_name' %}
<table>
<thead>
  <th>First Name</th>
  <th>Last Name</th>
