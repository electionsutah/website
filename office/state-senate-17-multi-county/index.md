---
title: State Senate 17 (Multi County)
permalink: "/office/state-senate-17-multi-county"
layout: page
comments: true
---
...
{% assign office = site.data.2018.primary.candidates | where:'office','State Senate 17 (Multi County)' | sort:'last_name' %}
<table>
<thead>
  <th>First Name</th>
  <th>Last Name</th>
