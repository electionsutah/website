---
title: State House 53 (Multi County)
permalink: "/office/state-house-53-multi-county"
layout: page
comments: true
---
...
{% assign office = site.data.2018.primary.candidates | where:'office','State House 53 (Multi County)' | sort:'last_name' %}
<table>
<thead>
  <th>First Names</th>
  <th>Last Names</th>
